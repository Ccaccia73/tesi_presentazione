...
\begin{frame}{Flapping wing: images}
    ...
    \centering
        ...
        \subfloat[deformed shape (10x)]{\includegraphics[width=5cm]{images/heathcote/naca0012_dy.png}}\hfil   
        %\subfloat[$t=7.4s$]{\includegraphics[width=3cm]{images/mesh/m05.png}}\hfil
        \subfloat[$F_Y$]{\includegraphics[width=5cm]{images/heathcote/naca0012_Fy.png}}
