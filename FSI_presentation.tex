...
\textcolor{dblue}{\textbf{Main features}:}

    \begin{itemize}
        \item \textcolor{teal}{\textbf{connection}} of single-physics solvers
        \item \textcolor{teal}{\textbf{partitioned}} multi-physics simulation: FSI, CHT, SSI
        \item \textcolor{teal}{\textbf{black-box}}: information only on interface nodes 
    \end{itemize}

\pause
\vspace{5mm}

\textcolor{dblue}{\textbf{Actions performed}:} 

\begin{itemize}
	\item \textcolor{teal}{\textbf{communication}} between the participants
	\item \textcolor{teal}{\textbf{coupling strategy}}
	\item \textcolor{teal}{\textbf{convergence}} method (acceleration) and criteria
	\item \textcolor{teal}{\textbf{mapping}} of data between meshes 
\end{itemize}
...
\subfloat[$t=7.5s$]{\includegraphics[width=3cm]{images/mesh/m06.png}}
