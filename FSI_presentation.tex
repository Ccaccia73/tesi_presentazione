...
\begin{description}[saved data]
    \item[*.vtu files] at each node (MBDyn output data)\\
                    \textcolor{dorange}{Displacements}, \textcolor{red}{Displacement Deltas}\\ 
                    \textcolor{dblue}{Velocities}\\
                    \textcolor{indigo}{Forces}
    \item[.csv file] with resultants, moments at each time step
    \item[MDByn] simulation output parsed through python file
\end{description}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth, trim=0 0 0 200,clip]{images/fsi2_disp.png}
